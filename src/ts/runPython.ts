...
export function deidentifyVideo(configStore: ConfigStore, afterFunction: any) {
	exec(`python ./src/py/deidentification.py "${configStore.videoPath}" "${configStore.skeletonPath}" "${configStore.savePath}"`, afterFunction);
}
